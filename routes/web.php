...
Route::group(['prefix' => 'room'], function () {
    Route::get('', [App\Http\Controllers\VideoChatController::class, 'index'])->name('room');
    Route::post('', [App\Http\Controllers\VideoChatController::class, 'generateRoom'])->name('room.generate');
